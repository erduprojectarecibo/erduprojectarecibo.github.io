...
// Tasa de Delitos Tipo 1 por cada 100,000 Habitantes (1960-2019)
...
$(document).ready(function () {
    Highcharts.chart('chart03', {
        ...
        title: {
            text: 'Tasa de delitos tipo 1 en Puerto Rico de 1960 a 2019',
        },
        ...
        series: [{
            ...
            data: [1416, 1599, 1964, 2196, 2257, 2233, 2314, 2317, 2481, 2304, 2451, 2582, 2545,
                ...
                1699, 1619, 1528, 1341, 1258, 1172, 976, 892
            ],
            color: '#2a8e40',
            animation: {
                enabled: true,
...
// Tasa Descendente de Delitos Tipo 1 por cada 100,000 habitantes (1992-2019)
...
$(document).ready(function () {
    var chart3 = Highcharts.chart('chart017', {
        ...
        title: {
            text: 'Gráfica 2: Tendencia tasa de delitos tipo 1 de 1992 a 2019',
        },
...
//Total de Delitos Tipo 1 en Puerto Rico (1960-2019)
...
$(document).ready(function () {
    Highcharts.chart('chart012', {
        ...
        title: {
            text: 'Gráfica 3: Total de delitos tipo 1 en Puerto Rico de 1960 a 2019',
        },
        ...
        series: [{
            ...
            data: [33272, 37982, 47514, 54159, 56746, 57117, 60013, 60735, 65616, 61480, 66470, 70438, 70423, 72363, 82293, 88095, 86079,
                ...
                62269, 62279, 61732, 58180, 54006, 46587, 42855, 38964, 31233, 28517
            ],
            color: '#2a8e40',
            animation: {
                enabled: true,
...
//Tasa de Asesinatos y Homicidios en Puerto Rico (1960-2019)
...
$(document).ready(function () {
    var chart5 = Highcharts.chart('chart018', {
        ...
        title: {
            text: 'Gráfica 4: Tasa anual de asesinatos y homicidios de 1960 a 2019',
        },
...
//Total de Asesinatos y Homicidios en Puerto Rico (1960-2019)
...
$(document).ready(function () {
    var chart6 = Highcharts.chart('chart020', {
        ...
        title: {
            text: 'Gráfica 4: Total anual de asesinatos y homicidios de 1960 a 2019',
        },
...
//Magnitud del Cambio en el Total de Delitos Tipo 1 por Gobernante y Cuatrenio (1961-2019)

...
$(document).ready(function() {
    ...
    Highcharts.chart('pchart01', {
            ...
            xAxis: [{
                ...
                opposite: true,
                reversed: false,
                categories: ['<strong> 2,210,703 </strong>', '366,277', '318,368', '270,730', '220,452', '193,113', '158,136', '131,892', '133,242', '91,225', '75,728', '71,223', '46,418', '48,905', '32,763', '21,424', '11,757', '9,673', '93,77', ' ', 'Total por <br/> Segmento'],
                linkedTo: 0,
                labels: {
                    style: {
                        color: 'black',

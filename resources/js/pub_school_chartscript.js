    ...
    Highcharts.chart('chart05', {
        ...
        series: [{
            ...
            data: [631358, 651030, 654762, 668520, 672249, 686777, 697410, 711238, 712588, 704873.5, 697159, 688596, 705007.5, 721419, 717149.5,
                ...
                365181, 346096, 307282, 292518, 276413, 262424
            ],
            color: '#2a8e40',
            animation: {
                enabled: true,
...
$(document).ready(function () {
    Highcharts.chart('epchart02', {
        ...
        title: {
            text: 'Cambio en la matrícula total anual (1966-2021)',
        },
        ...
        tooltip: {
            ...
            formatter: function () {
                ...
                } else if (this.x == '1965' || this.x == '2022') {
                    return 'N/A'
                } else {
                    return this.x + ' <br>' + 'Cambio Positivo en la Matrícula Total: ' + this.y
                }
            },
        },
        ...
        series: [{
            ...
            data: [null, 19672, 3732, 13758, 3729, 14528, 10633, 13828, 1350, -7714, -7714, -8563, 16411, 16411, -4269, -4269,
                ...
                -18131, -10675, -12984, -31132, -14637, -19085, -38814, -23571, -19438, -13989, null
            ],
            color: 'black',
            animation: {
                enabled: true,
...
$(document).ready(function () {
    Highcharts.chart('epchart03', {
        ...
        title: {
            text: 'Cambio porcentual en la matrícula total anual (1966-2021)',
        },
        ...
        tooltip: {
            ...
            formatter: function () {
                if (this.y < 0) {
                    ...
                    return this.x + ' <br>' + 'Cambio Porcentual Positivo en la Matrícula: ' + this.y + ' %'
                }
            },
        },
        ...
        series: [{
            ...
            data: [0, 3.12, 0.57, 2.10, 0.56, 2.16, 1.55, 1.98, 0.19, -1.08, -1.09, -1.23, 2.38, 2.33, -0.59, -0.60, 1.20,
                ...
                -4.00, -2.46, -3.06, -7.58, -3.85, -5.23, -11.2, -7.38, -6.60, -5.1, 0
            ],
            color: 'black',
            animation: {
                enabled: true,
